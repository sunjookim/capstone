...
namespace Ardunity
{
    ...
    public class Game2 : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            {
                // bird_01 활성화 및 이동시키기
                //GameObject.FindGameObjectWithTag("bird_01").SetActive(true);
                //Bird_01 = true;
        ...
        void Update()
        {
            ...
            //print("IsCountDownDo: " + IsCountDownDo);
            ...
            */
            ...
            if((int)_time == 36 || (int)_time == 58 || (int)_time == 76 || (int)_time == 95 || (int)_time == 119 || (int)_time == 149 || (int)_time == 166 || (int)_time == 180 || (int)_time == 192 || (int)_time == 204 )
            {
                isFail = false;
                slopeGoodtime = 0.0f;
            } 
            ...
            if (_time >= 26f && _time <= 31.9f) // slope_01
            {
                ...
                if(_time >= 26f && _time <= 29.9f) // 기울여서 내려가는 동작이 실행되는 시간에 다음 동작의 파라미터를 결정(실제보다 좀 더 촉박하게 잡음)
                {
            ...
            } else if(_time >= 83.4f && _time <= 90.5f) // slope_04
            {
                animator1.SetBool("LeftBack", false);
            ...
            } else if(_time >= 108.2f && _time <= 115.1f) // slope_05
            {
                animator1.SetBool("RightBack", false);
            ...
            } else if(_time >= 138f && _time <= 145.4f) // slope_06
            {
                animator1.SetBool("LeftBack", false);
            ...
            } else if(_time >= 156f && _time <= 162.5f) // slope_07
            {
                animator1.SetBool("RightBack", false);
            ...
            } else if(_time >= 169.4f && _time <= 176.9f) // slope_08
            {
                animator1.SetBool("LeftBack", false);
            ...
            } else if(_time >= 182.5f && _time <= 188.7f) // slope_09
            {
                animator1.SetBool("RightBack", false);
            ...
            else if (_time >= 90.5f && _time <= 108.2f)
            {
                //nvAgent.Resume();
                //txtSound.text = " ";
                nvAgent.isStopped = false;
            ...
            else if (_time >= 115.1f && _time <= 138f)
            {
                //nvAgent.Resume();
                //txtSound.text = " ";
                nvAgent.isStopped = false;
            ...
            else if (_time >= 145.4f && _time <= 156f)
            {
                //nvAgent.Resume();
                //txtSound.text = " ";
                nvAgent.isStopped = false;
            ...
            else if (_time >= 162.5f && _time <= 169.4f)
            {
                //nvAgent.Resume();
                //txtSound.text = " ";
                nvAgent.isStopped = false;
            ...
            else if (_time >= 176.9f && _time <= 182.5f)
            {
                //nvAgent.Resume();
                //txtSound.text = " ";
                nvAgent.isStopped = false;
            ...
            else if (_time >= 188.7f && _time <= 194.1f)
            {
                //nvAgent.Resume();
                //txtSound.text = " ";
                nvAgent.isStopped = false;
